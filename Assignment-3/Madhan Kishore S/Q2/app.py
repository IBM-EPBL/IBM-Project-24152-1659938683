...
COS_API_KEY_ID="cxQugnxKE87uU6FM09KOnnz5G42Uqq_DBMZQ4Z_R00dk"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/f89ed34e547a4554a5a4b49618f272e3:1c3841c7-b324-4406-ad9d-b6cc3f3a3ccf:bucket:madhan-idm"
...
@app.route('/')
def index():
    files = get_bucket_contents('rithika-ibm')
